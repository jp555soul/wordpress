...
<!-- Begin Portfolio Section -->
  <div id="<?php echo the_slug(); ?>" class="portfolio-page borderline"> 
    ...
    <ul id="content" class="gallerynav">
      <li class="active"><a href="#" data-value="all"><?php _e("All", "elemis"); ?></a></li>
      <?php 
  $categories=  get_categories('taxonomy=filter&orderby=id'); 
  foreach ($categories as $cat) {
  	$input = '<li><a href="#" data-value="'.$cat->category_nicename.'">';
	$input .= $cat->cat_name;
	$input .= '</a></li>';
	echo $input;
  } ?>
	...
	<?php while($recent->have_posts()) : $recent->the_post(); ?>
      ...
      <!-- Begin Item -->
          <li data-id="<?php echo "".get_the_id();?>" <?php post_class(); ?>>
...
if ($attachments) {
	foreach ($attachments as $attachment) {
        ...
        echo '<li><a title="'.$attachment->post_title.'" data-rel="prettyPhoto['.$post->ID.']" href="'.$attachment_img.'">';
