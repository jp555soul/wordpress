...
wp_register_script('jquery', get_template_directory_uri().'/style/js/jquery-1.5.1.min.js');//load jquery from google api, and place in footer
...
wp_enqueue_script( 'cufon', get_template_directory_uri().'/style/js/cufon.yui.js', array('jquery'));
wp_enqueue_script( 'titillium', get_template_directory_uri().'/style/js/titillium.js', array('jquery'));
...
wp_enqueue_script( 'nav', get_template_directory_uri().'/style/js/jquery.nav.min.js', array('jquery'));
wp_enqueue_script( 'prettyphoto', get_template_directory_uri().'/style/js/jquery.prettyPhoto.js', array('jquery'));
...
wp_enqueue_script( 'tinynav', get_template_directory_uri().'/style/js/tinynav.min.js', array('jquery'));
